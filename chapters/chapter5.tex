...
\begin{figure}[h]
    \centering
    \subfloat[target front]{\includegraphics[width=.8\textwidth]{./resources/img/00303_textured_target.pdf}}\\
    \subfloat[deformed mean]{\includegraphics[width=.8\textwidth]{./resources/img/00303_fit.pdf}}\\
    \subfloat[distance]{\includegraphics[width=.8\textwidth]{./resources/img/00303_distmap.pdf}}
    \caption{}
\label{fig:distmap}
% reference in text by \ref{$figure-name}
\end{figure}
