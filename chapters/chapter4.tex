...
\viscomment{Where to put this? Already rewritten}
...
\section{Prior Model}
Build Model from template/mean mesh using Gaussian Prior
\section{Posterior Model}
Build Model from mean and target landmarks
